...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $pdo->prepare("INSERT INTO buku (judul, pengarang, penerbit, tahun_terbit, kategori, stok, gambar) VALUES (?, ?, ?, ?, ?, ?, ?)");
    $stmt->execute([$judul, $pengarang, $penerbit, $tahun_terbit, $kategori, $stok, $gambar]);
